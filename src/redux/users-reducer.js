...
const FOLLOW = 'social-net/users/FOLLOW';
const UNFOLLOW = 'social-net/users/UNFOLLOW';
const SET_USERS = 'social-net/users/SET_USERS';
...
const TOGGLE_IN_FOLLOWING_PROGRESS = 'social-net/users/TOGGLE_IN_FOLLOWING_PROGRESS';
